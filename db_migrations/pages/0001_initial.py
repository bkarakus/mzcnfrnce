    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_meta_title_en', models.CharField(help_text='Optional title to be used in the HTML title tag. If left blank, the main title field will be used.', max_length=500, null=True, verbose_name='Title', blank=True)),
                ('_meta_title_tr', models.CharField(help_text='Optional title to be used in the HTML title tag. If left blank, the main title field will be used.', max_length=500, null=True, verbose_name='Title', blank=True)),
                ('description', models.TextField(verbose_name='Description', blank=True)),
                ('description_en', models.TextField(null=True, verbose_name='Description', blank=True)),
                ('description_tr', models.TextField(null=True, verbose_name='Description', blank=True)),
                ...
                ('in_menus', mezzanine.pages.fields.MenusField(max_length=100, null=True, verbose_name='Show in menus', blank=True)),
                ('titles', models.CharField(max_length=1000, null=True, editable=False)),
                ('titles_en', models.CharField(max_length=1000, null=True, editable=False)),
                ('titles_tr', models.CharField(max_length=1000, null=True, editable=False)),
