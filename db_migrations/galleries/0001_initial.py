    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_en', models.CharField(max_length=1000, null=True, verbose_name='Description', blank=True)),
                ('description_tr', models.CharField(max_length=1000, null=True, verbose_name='Description', blank=True)),
