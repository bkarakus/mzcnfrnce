...
class HomePage(Page, RichText):
        ...
        heading = models.CharField(
                            max_length = 100, 
                            help_text = 'Heading for paragraph',
                            default = 'Super Cool Heading')
        #paragraph blurb
        paragraph_blurb = models.CharField(
                                    max_length = 600,
...
class Slide(Orderable):
        ...
        caption = models.CharField(max_length = 100, default = 'Blurb for image')